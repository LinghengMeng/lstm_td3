...
def vpg(env_name, partially_observable=False,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--partially_observable', type=bool, default=False)
    ...
    vpg(env_name=args.env, partially_observable=args.partially_observable,
