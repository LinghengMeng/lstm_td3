...
import pybulletgym
import time
import spinup.algos.pytorch.ddpg_conservative.core as core
...
def ddpg(env_name, partially_observable=False,
    ...
    def compute_loss_q(data):
        ...
        loss_info = dict(QVals=q.detach().cpu().numpy(),
                         ...
                         QConservativePenalty=q_conservative_penalty.detach().cpu().numpy(),
    ...
    for t in range(total_steps):
        ...
        if (t+1) % steps_per_epoch == 0:
            ...
            logger.log_tabular('QConservativePenalty', with_min_and_max=True)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--penalty_beta', type=float, default=1e-4)
