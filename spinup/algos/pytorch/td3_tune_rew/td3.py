...
import time
import spinup.algos.pytorch.td3_tune_rew.core as core
...
if __name__ == '__main__':
    ...
    parser.add_argument('--tune_reward_type', type=str, choices=['addition_tunning', 'multiplication_tunning'], default=None)
